...
138|    const scrollContainer = scrollContainerRef.current;
139|    if (scrollContainer) {
140|      scrollContainer.addEventListener('scroll', checkScroll);
141|      window.addEventListener('resize', handleResize); // Use handleResize for resize events

142|      return () => {
143|        scrollContainer.removeEventListener('scroll', checkScroll);
